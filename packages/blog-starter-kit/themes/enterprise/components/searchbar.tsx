	...
	return (
		<div className="relative col-span-1">
			<input
				...
				className="w-full rounded-lg border border-[#ddd] bg-[#fff] px-4 py-2 text-base focus:bg-transparent dark:border-neutral-800 dark:bg-neutral-800 dark:text-neutral-50 dark:placeholder:text-neutral-400 dark:hover:bg-neutral-950"
			/>
			{query && (
				<>
					{isSearching && (
